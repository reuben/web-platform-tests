...
(function() {
  ...
  function FakeBluetoothChooser_SetManual_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  FakeBluetoothChooser_SetManual_Params.prototype.initDefaults_ = function() {
    this.enable = false;
  };
  FakeBluetoothChooser_SetManual_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  FakeBluetoothChooser_SetManual_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FakeBluetoothChooser_SetManual_Params.encodedSize = codec.kStructHeaderSize + 8;

  FakeBluetoothChooser_SetManual_Params.decode = function(decoder) {
    var packed;
    var val = new FakeBluetoothChooser_SetManual_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
  ...
  FakeBluetoothChooser_SetManual_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(FakeBluetoothChooser_SetManual_Params.encodedSize);
    encoder.writeUint32(0);
    packed = 0;
  ...
  function FakeBluetoothChooser_SetManual_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  FakeBluetoothChooser_SetManual_ResponseParams.prototype.initDefaults_ = function() {
  };
  FakeBluetoothChooser_SetManual_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  FakeBluetoothChooser_SetManual_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FakeBluetoothChooser_SetManual_ResponseParams.encodedSize = codec.kStructHeaderSize + 0;

  FakeBluetoothChooser_SetManual_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new FakeBluetoothChooser_SetManual_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  FakeBluetoothChooser_SetManual_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(FakeBluetoothChooser_SetManual_ResponseParams.encodedSize);
    encoder.writeUint32(0);
  };
  ...
  var kFakeBluetoothChooser_SetManual_Name = 1598418367;
  var kFakeBluetoothChooser_WaitForEvents_Name = 855398769;
  var kFakeBluetoothChooser_SelectPeripheral_Name = 1893006722;
  var kFakeBluetoothChooser_Cancel_Name = 1138944817;
  var kFakeBluetoothChooser_Rescan_Name = 182136115;
  ...
  FakeBluetoothChooserPtr.prototype.setManual = function() {
    return FakeBluetoothChooserProxy.prototype.setManual
        .apply(this.ptr.getProxy(), arguments);
  };

  FakeBluetoothChooserProxy.prototype.setManual = function(enable) {
    var params = new FakeBluetoothChooser_SetManual_Params();
    params.enable = enable;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kFakeBluetoothChooser_SetManual_Name,
          codec.align(FakeBluetoothChooser_SetManual_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(FakeBluetoothChooser_SetManual_Params, params);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(FakeBluetoothChooser_SetManual_ResponseParams);
  ...
  FakeBluetoothChooserStub.prototype.setManual = function(enable) {
    return this.delegate_ && this.delegate_.setManual && this.delegate_.setManual(enable);
  }
  ...
  FakeBluetoothChooserStub.prototype.acceptWithResponder =
    ...
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    case kFakeBluetoothChooser_SetManual_Name:
      var params = reader.decodeStruct(FakeBluetoothChooser_SetManual_Params);
      this.setManual(params.enable).then(function(response) {
        var responseParams =
            new FakeBluetoothChooser_SetManual_ResponseParams();
        var builder = new codec.MessageV1Builder(
            kFakeBluetoothChooser_SetManual_Name,
            codec.align(FakeBluetoothChooser_SetManual_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(FakeBluetoothChooser_SetManual_ResponseParams,
                             responseParams);
        var message = builder.finish();
    ...
    switch (message.getName()) {
      case kFakeBluetoothChooser_SetManual_Name:
        if (message.expectsResponse())
          paramsClass = FakeBluetoothChooser_SetManual_Params;
      break;
      case kFakeBluetoothChooser_WaitForEvents_Name:
        if (message.expectsResponse())
   ...
   switch (message.getName()) {
      case kFakeBluetoothChooser_SetManual_Name:
        if (message.isResponse())
          paramsClass = FakeBluetoothChooser_SetManual_ResponseParams;
        break;
      case kFakeBluetoothChooser_WaitForEvents_Name:
        if (message.isResponse())
